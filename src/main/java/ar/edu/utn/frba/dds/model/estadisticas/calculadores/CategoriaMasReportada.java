...
public class CategoriaMasReportada implements CalculadorEstadistica {

    @Override
    public byte[] calcularYGenerarCSV(HechoRepository hechoRepo, RepositorioSolicitudes solRepo,
                                    Map<String, String> parametros) {

        List<Object[]> resultados = hechoRepo.contarHechosPorCategoria();
    ...
    public String[] getEncabezadoCSV() {
        return new String[]{"Categoria", "Cantidad_Hechos"};
    }
}